  ...
  <div>
    <nav itemscope itemtype="http://schema.org/SiteNavigationElement" class="main-navigation">
      <div class="content nav-content">
        <a href="index.html" data-destination="home" itemprop="url" class="nav-logo">
          <svg xmlns="http://www.w3.org/2000/svg" id="my-svg" version="1.0" width="256" height="256" viewBox="0 0 500.000000 500.000000" preserveAspectRatio="xMidYMid meet">
        ...
        <ul class="nav-links">
          ...
          <li itemprop="name">
            <a href="#about" data-scroll itemprop="url" class="no-smoothState no-single-work">.about()</a>
          </li>
          <li itemprop="name">
            <a href="#portfolio" data-scroll itemprop="url" class="no-smoothState no-single-work">.portfolio()</a>
          </li>
    ...
    <nav class="mobile-menu"><span aria-label="Close" class="close-trigger"><i class="close-trigger-bar left"></i><i
      ...
      <ul class="mobile-nav-links">
        ...
        <li>
          <a href="#about" data-scroll class="no-smoothState no-single-work">.about()</a>
        </li>
        <li>
          <a href="#portfolio" data-scroll class="no-smoothState no-single-work">.portfolio()</a>
        </li>
        <li>
