    ...
    <header id="top" class="main-hero">
        ...
        <ul itemscope itemtype="http://schema.org/Organization" class="social-vertical-stripe"><span itemprop="name"
            ...
            <li><a href="https://it.linkedin.com/in/riccardozanutta" target="_blank" rel="noopener"
                    itemprop="sameAs"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
            ...
            <li>
                <a href="https://twitter.com/RiccardoZanutta" target="_blank" rel="noopener" itemprop="sameAs">
                    <img src="/icons/facebook.svg" />
                </a>
            </li>
            <li><a href="https://github.com/taha2002" target="_blank" rel="noopener" itemprop="sameAs"><svg
                        xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewbox="0 0 438.549 438.549">
                        <path
            ...
            <li><a href="https://dribbble.com/rickzan" target="_blank" rel="noopener" itemprop="sameAs"
                    class="dribbble"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23"
