  ...
  <div class="about-contact">
    ...
    <div class="half-contact is-about">
      ...
      <div class="contact-info">
        ...
        <h4 class="h5 about-me-subtitle">Back-end developer.</h4>
        <p class="about-me-text">I&apos;m Taha Bouras, a 22-year-old Italian <strong>Freelance
          ...
          interaction, developing rich web experiences &amp; <strong>web applications</strong>.
          <br>
        ...
        <ul class="about-me-list">
          ...
          <li class="uiux">
            <div class="about-me-list-label">UI/UX</div><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128"
              viewbox="0 0 128 128">
              <path
              ...
              <path d="M7.5 7.2V119h111.8V7.2H7.5zm3.7 3.8h104.4v18.6H11.2V11zm104.4 104.3H11.2v-82h104.4v82z">
              </path>
              <path
          ...
          <li class="css-code">
            <div class="about-me-list-label">is Fun.</div><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
              viewBox="0 0 32 32">
              <path fill="#444"
          ...
          <li class="fun">
            <div class="about-me-list-label">Semicolons.</div><svg xmlns="http://www.w3.org/2000/svg" width="32"
