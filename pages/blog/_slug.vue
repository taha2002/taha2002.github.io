        ...
        <div id="single-work" itemscope itemtype="http://schema.org/CreativeWork" class="cerasa">
            <header style="background-image: url('/img/cerasa-work.jpg');" id="top" class="hero-single-work">
                ...
                <div class="cookie-banner"><svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 416.991 416.991">
                    ...
                    <p>This website uses <a href="privacy.html">cookies.</a> - <span
                            class="confirm-cookies">Dismiss</span></p>
                </div>
            </header>
        ...
        <div class="about-contact">
            <div id="contact-half" class="half-contact is-contact">
                ...
                <div class="contact-info">
                    ...
                    <p class="form-subtitle">New projects, freelance inquiry or even a coffee.</p>
                    <div class="inner-container">
                        <form id="contact-form" method="post" action="https://riccardozanutta.com/mailer.php"
                            ...
                            <div class="inner-container"><button type="submit" disabled
                                    class="the-button submit-button"><span class="button-text">Send Message</span>
            ...
            <div class="half-contact is-about">
                ...
                <div class="contact-info">
                    <h3 class="h4 about-me-title">About Me.</h3>
                    <h4 class="h5 about-me-subtitle">Interactive Front-end developer.</h4>
                    <p class="about-me-text">I&apos;m Riccardo Zanutta, a 22-year-old Italian <strong>Freelance
                            Front-end developer</strong>. I&apos;m a weird guy who likes making weird things with web
                        technologies. <br>I like to <strong>resolve</strong> design problems, <strong>create</strong>
                        smart user interface and <strong>imagine</strong> useful interaction, developing rich web
                        experiences &amp; <strong>web applications</strong>. <br> When not working or futzing around
                        with code, I study how to escape from University. Actually <strong>for hire</strong>.</p>
                    <ul class="about-me-list">
                        ...
                        <li class="fun">
                            <div class="about-me-list-label">Semicolons.</div><svg xmlns="http://www.w3.org/2000/svg"
                                width="32" height="32" viewBox="0 0 32 32">
                                <path fill="#444"
